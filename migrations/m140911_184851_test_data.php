...
class m140911_184851_test_data extends \yii\db\Migration
{
    public function up()
    {
    	...
    	$this->insert('product', [
    			...
    			'home_link' => 'http://en.wikipedia.org/wiki/The_Hunger_Games',
    			'report_link' => '',
    			'requirements' => 'big bad luck',
    			'short_description' => 'The Hunger Games is a multimedia franchise created by Suzanne Collins.',
    			'description' => 'The Hunger Games is a multimedia franchise created by Suzanne Collins. Set in The Hunger Games universe, the franchise began with The Hunger Games, the first book in The Hunger Games trilogy. The novels have been developed into a series of films.',
    			'installation' => 'Don`t need',
    			'stars' => 0,
    			'price' => 0.01,
    	...
    	$this->insert('product', [
    			...
    			'id_category' => 5,
    			'name' => 'Конфуцій',
    			'home_link' => 'http://uk.wikipedia.org/wiki/%D0%9A%D0%BE%D0%BD%D1%84%D1%83%D1%86%D1%96%D0%B9',
    			'report_link' => 'shvabuk@gmail.com',
    			'requirements' => 'веб-переглядач',
    			'short_description' => 'Соціальна мережа порядностію',
    			'description' => 'Соціальна мережа порядності, в якій плюсами і мінусами виставляються "карми" державних чиновників.',
    			'installation' => 'Don`t need',
    			'stars' => 1,
    			'price' => Null,
    			'author' => 'Геракл і Іолай',
    			'id_publisher' => 1,
    			'active' => 1,
    			'position' => 0,
    			]);
    	$this->insert('product', [
    			...
    			'id_category' => 6,
    			'name' => 'Дао',
    			'home_link' => 'http://en.wikipedia.org/wiki/Tao',
    			'report_link' => 'shvabuk@gmail.com',
    			'requirements' => 'Ще незнаю',
    			'short_description' => 'Математика добра і зла',
    			'description' => 'Програма, що базується на методології визначення добра і зла',
    			'installation' => 'Слідуйте інструкціям',
    			'stars' => 1,
    			'price' => Null,
    			'author' => 'напівбоги',
    			'id_publisher' => 1,
